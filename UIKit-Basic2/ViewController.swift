...
class ViewController: UIViewController {
    ...
    func showMenu(sourceView: UIView) {
        ...
        alert.addAction(UIAlertAction(title: "Open", style: .default) { [weak self] _ in self?.showMessage("Open chosen")
        })
        alert.addAction(UIAlertAction(title: "Find", style: .default) { [weak self] _ in self?.showMessage("Find chosen")
        })
